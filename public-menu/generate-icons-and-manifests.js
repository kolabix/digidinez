...
function generateManifest(restaurant, iconUrls) {
  ...
  if (iconUrls) {
    // Handle the actual filenames generated by favicons
    if (iconUrls['android-chrome-192x192.png']) {
      manifest.icons.push({
        src: iconUrls['android-chrome-192x192.png'],
        sizes: '192x192',
        type: 'image/png'
      });
    }
    
    if (iconUrls['android-chrome-512x512.png']) {
      manifest.icons.push({
        src: iconUrls['android-chrome-512x512.png'],
        sizes: '512x512',
        type: 'image/png'
      });
    }
    
    if (iconUrls['apple-touch-icon.png']) {
      manifest.icons.push({
        src: iconUrls['apple-touch-icon.png'],
        sizes: '180x180',
        type: 'image/png'
      });
    }
    
    if (iconUrls['favicon-32x32.png']) {
      manifest.icons.push({
        src: iconUrls['favicon-32x32.png'],
        sizes: '32x32',
        type: 'image/png'
      });
    }
    
    if (iconUrls['favicon-16x16.png']) {
      manifest.icons.push({
        src: iconUrls['favicon-16x16.png'],
        sizes: '16x16',
        type: 'image/png'
      });
    }
...
function patchHTML(restaurantId, iconUrls, manifestPath) {
  ...
  try {
    ...
    if (iconUrls) {
      // Use the actual filenames generated by favicons
      if (iconUrls['favicon-16x16.png']) {
        faviconTags.push(`<link rel="icon" type="image/png" sizes="16x16" href="${iconUrls['favicon-16x16.png']}">`);
      }
      
      if (iconUrls['favicon-32x32.png']) {
        faviconTags.push(`<link rel="icon" type="image/png" sizes="32x32" href="${iconUrls['favicon-32x32.png']}">`);
      }
      
      if (iconUrls['apple-touch-icon.png']) {
        faviconTags.push(`<link rel="apple-touch-icon" sizes="180x180" href="${iconUrls['apple-touch-icon.png']}">`);
      }
      
      if (iconUrls['android-chrome-192x192.png']) {
        faviconTags.push(`<link rel="icon" type="image/png" sizes="192x192" href="${iconUrls['android-chrome-192x192.png']}">`);
      }
      
      if (iconUrls['android-chrome-512x512.png']) {
        faviconTags.push(`<link rel="icon" type="image/png" sizes="512x512" href="${iconUrls['android-chrome-512x512.png']}">`);
      }
      
      if (iconUrls['favicon.ico']) {
        faviconTags.push(`<link rel="icon" href="${iconUrls['favicon.ico']}">`);
      }
    }
